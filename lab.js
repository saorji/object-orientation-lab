...
favoriteThings.show = 'Games of Thrones'
...
//Code Here
let {make, model, year} = carDetails
//console.log(color)
...
let {utah, california, texas, arizona} = cities
return Number(utah+california+texas+arizona)

}
console.log(totalPopulation(cities))
...
// }
// arr1 = [],
// function ingredients (nuts){
 
//   let {carb} = foodnut
//   return arr1.push(carb)
// }
// ingredients()
// console.log(arr1)
...
let cat1= new Cat('Deuces',2, 'black')
